...
import { ChevronDown, ChevronRight, Search, Home, Users, GraduationCap, UserCheck, Calendar, Briefcase, Heart, Phone } from "lucide-react";
...
const Sitemap = () => {
  ...
  const getAllLinks = (items: SitemapItem[]): SitemapItem[] => {
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-gray-200">
            ...
            <span className="text-sm text-gray-600">
              {getAllLinks(sitemapData).length + sitemapData.length} total pages available
            </span>
          </div>
        </div>
      </div>
